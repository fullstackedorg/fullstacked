...
const toPatch = [
    {
        ...
        replace: [{
            ...
            to: `inferredProjectName = ".inferred"`
        }]
        ...
        replace: [
            {
                ...
                to: `Label:         strings.ToValidUTF8(displayParts.String(), ""),`
            },
            {
                from: `Label:         display.String(),`,
                to: `Label:         strings.ToValidUTF8(display.String(), ""),`
            }
        ]
    },
    {
        ...
        replace: [
            {
                ...
                to: `if runtime.GOOS == "windows" || runtime.GOOS == "ios" {`
            }
        ]
    }
]
...
function patch() {
    toPatch.forEach(p => {
        ...
        p.replace.forEach(({ from, to }) => contents = contents.replace(from, to))
