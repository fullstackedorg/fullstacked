...
require (
	...
	github.com/evanw/esbuild v0.27.2 // direct
	github.com/go-git/go-git/v5 v5.16.4 // direct
)
...
require (
	...
	github.com/go-git/go-git/v6 v6.0.0-20260123133532-f99a98e81ce9 // indirect
