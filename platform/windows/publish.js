...
/*
 *
 * Fix for: https://github.com/microsoft/WindowsAppSDK/issues/5820
 *
 */
...
contents = contents.replace(
    /WinAppSdkSignAppxPackageBundle/g,
...
child_process.execSync(
    `call ./windows.bat arm64 ${noTSGO ? "NO_TSGO=1" : ""}`,
    {
...
if (fs.existsSync(appPackages)) fs.rmSync(appPackages, { recursive: true });
